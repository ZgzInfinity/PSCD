...
int main(){
	...
	const char fichero[MAX_LONG_FICHERO] = "log1.log";
	const char fichEstadistico[MAX_LONG_FICHERO] = "log1_estad.log";
	...
	if (f1.is_open() && f2.is_open()){
		...
		// Variables para medir el tiempo aleatorio
		int tiempo;
		...
		// Termina el proceso estadistico
